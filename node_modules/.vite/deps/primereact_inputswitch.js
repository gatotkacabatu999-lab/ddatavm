...
var InputSwitch = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  ...
  var sliderProps = mergeProps2({
    className: cx("slider")
  }, ptm("slider"));
  return React6.createElement(React6.Fragment, null, React6.createElement("div", _extends3({
    id: props.id,
    ref: elementRef
  }, rootProps), React6.createElement("input", _extends3({
    ref: inputRef
  }, inputProps)), React6.createElement("span", sliderProps)), hasTooltip && React6.createElement(Tooltip, _extends3({
    target: elementRef,
