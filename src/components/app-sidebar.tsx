    ...
    >
      ...
      <SidebarFooter>
        ...
        >
          ...
          <span className="flex-1 text-[12.5px] font-medium text-sidebar-foreground/90">
        ...
        >
          ...
          <span className={`flex-1 text-[12.5px] font-medium ${isEditMode ? "text-primary" : "text-sidebar-foreground/90"}`}>
