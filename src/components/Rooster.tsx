      ...
      <div className={`flex-1 min-h-0 overflow-auto transition-all duration-200 ease-out ${viewModeTransition === "out" ? "opacity-0 scale-[0.98]" : "opacity-100 scale-100"}`}>
        {resources.length === 0 ? (
          ...
          <table className="border-collapse text-center w-full" style={{ tableLayout: "fixed" }}>
            ...
            <thead>
              <tr>
                <th className="sticky top-0 left-0 z-30 border-b border-l border-r border-border px-2 py-2 text-center" style={{ width: `${staffColWidth}px`, minWidth: `${staffColWidth}px`, backgroundColor: 'var(--background)' }}>
              ...
              {orderedResources.map((resource, ri) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* ── Staff cell ── */}
                    <td className="sticky left-0 z-10 border-b border-l border-r border-border p-2 align-top" style={{ backgroundColor: 'var(--background)' }}>
